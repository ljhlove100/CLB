...
public class UsersController {
	...
	public String findpw(Model model, MailVO vo, HttpServletRequest request, HttpServletResponse response)
			throws IOException {
...
/*	// 정보수정
	...
	public String profile(Model model, UsersVO vo, HttpServletRequest request, HttpServletResponse response)
			throws IOException {
		...
		int profile = UsersService.profile(u_id, name);
		...
		if (profile == 1) {
			...
			UsersVO profile1 = UsersService.getUsers(u_id);
